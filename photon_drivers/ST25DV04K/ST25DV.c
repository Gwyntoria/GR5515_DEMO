...
int8_t ST25DV_ReadUid(void)
{
	...
	switch(GET_ID)
	{
		case ST25DV04K_IE_UID:
			printf("Drivers is ST25DV04K_IE\r\n");
			return NFCTAG_OK;
		case ST25DV04K_JF_UID:
			printf("Drivers is ST25DV04K_JF\r\n");
			return NFCTAG_OK;
		case ST25DV64K_IE_UID:
			printf("Drivers is ST25DV16K_IE or ST25DV64K_IE\r\n");
			return NFCTAG_OK;
		case ST25DV64K_JF_UID:
			printf("Drivers is ST25DV16K_JF or ST25DV64K_JF\r\n");
			return NFCTAG_OK;
		case ST25DV04KC_IE_UID:
			printf("Drivers is ST25DV04KC_IE\r\n");
			return NFCTAG_OK;
		case ST25DV64KC_IE_UID:
			printf("Drivers is ST25DV16KC_IE or ST25DV64KC_IE\r\n");
			return NFCTAG_OK;
		case ST25DV04KC_JF_UID:
			printf("Drivers is ST25DV04KC_JF\r\n");
			return NFCTAG_OK;
		case ST25DV64KC_JF_UID:
			printf("Drivers is ST25DV16KC_JF or ST25DV64KC_JF\r\n");
			return NFCTAG_OK;
		default:
			printf("Errors in testing equipment\r\n");
			return NFCTAG_ERROR;
	}
}
