...
#define GH3X2X_ALGO_FUNCTION_GROUP_0 (GH3X2X_FUNCTION_HR|GH3X2X_FUNCTION_HRV|GH3X2X_FUNCTION_SOFT_ADT_GREEN|GH3X2X_FUNCTION_SOFT_ADT_IR)
...
#define __USE_GOODIX_RESP_ALGORITHM__          (1)
#define __USE_GOODIX_AF_ALGORITHM__            (1)
