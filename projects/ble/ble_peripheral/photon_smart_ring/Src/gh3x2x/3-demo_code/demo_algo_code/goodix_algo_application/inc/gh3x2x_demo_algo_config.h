...
#define __ALGO_RUN_SIMULTANEOUSLY_SUPPORT__    (SUPPORT_GROUP_MULTI_ALGORITHM)   // SUPPORT_NO_MULTI_ALGORITHM / SUPPORT_MULTI_ALGORITHM / SUPPORT_GROUP_MULTI_ALGORITHM

#ifdef GOODIX_DEMO_PLANFORM
//#include "Goodix_Platform_config.h"
#endif

#define GH3X2X_ALGO_FUNCTION_GROUP_0 (GH3X2X_FUNCTION_HR|GH3X2X_FUNCTION_HRV|GH3X2X_FUNCTION_SOFT_ADT_GREEN|GH3X2X_FUNCTION_SOFT_ADT_IR|GH3X2X_FUNCTION_SPO2)
